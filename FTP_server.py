...
def help():
    return 'pwd - вернуть название рабочей директории\n' \
           'ls - вернуть список файлов в рабочей директории\n' \
           'mkdir -  создать директорию с указанным именем\n' \
           'rmdir -  удалить директорию с указанным именем\n' \
           'touch -  создать файл с указанным именем\n' \
           'rm -  удалить файл с указанным именем\n' \
           'move -  переместить файл/директорию в другую директорию\n' \
           'rename -  переименновывать файл с указанным именем \n' \
           'cat -  вернуть содержимое файла\n' \
           'help - выводить справку по командам\n' \
